---
name: ui-ux-pro-max
description: Searchable UI/UX design database (67 styles, 96 palettes, 57 font pairings, 99 UX guidelines, chart types) with a design-system generator. Use when choosing a visual style, palette, typography or UX patterns for an app or landing page, or when writing UI prompts for Lovable. Pair with anti-ai-slop-ui-ux to avoid generic AI looks. Source: Vanszs/Anti-AI-UI@fd2a142 (manually vendored; frontmatter added).
---
